...
//        System.out.printf("Wartość średnia: %.2f\n", ArraysStatistics.avg(numbers));
        ...
        System.out.println(ArraysStatistics.min(new int[] {2,2,3,4,1}));
        System.out.println(ArraysStatistics.max(new int[] {2,2,3,4,1}));
        System.out.println(ArraysStatistics.avg(new int[] {1,2,3,4,7}));
        System.out.println(ArraysStatistics.sum(new int[] {2,2,3,4,1}));
    }
}
